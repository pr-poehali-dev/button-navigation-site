...
export default function PageLayout({ title, subtitle, icon, children }: PageLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <header className="px-8 py-4 border-b border-border sticky top-0 bg-background/95 backdrop-blur-sm z-10">
      ...
      <main className="flex-1 px-8 pt-12 pb-16 animate-fade-in">
